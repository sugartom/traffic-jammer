...
# traffic_mobilenet = TrafficMobilenet()
# traffic_mobilenet.Setup()
...
# traffic_mobilenet.PreProcess(request, istub, False)
# traffic_mobilenet.Apply()
# next_request = traffic_mobilenet.PostProcess(False)
